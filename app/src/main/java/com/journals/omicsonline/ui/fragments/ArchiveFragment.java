...
import com.journals.omicsonline.databinding.FragmentArchiveBinding;
import com.journals.omicsonline.helper.utils;
import com.journals.omicsonline.model.ArchiveResponse;
import com.journals.omicsonline.ui.adapter.ArchiveHeadAdapter;
import com.journals.omicsonline.ui.viewmodel.ArchiveViewModel;
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container,
        ...
        archiveViewModel.getArchiveRepository().observe(getViewLifecycleOwner(), homeResponse -> {
            ...
            if (homeResponse != null){
                ...
                archiveHeadAdapter = new ArchiveHeadAdapter(archiveDetailsBeanArrayList,journalcode);
