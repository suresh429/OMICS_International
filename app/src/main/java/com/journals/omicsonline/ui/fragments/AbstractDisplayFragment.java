...
import com.journals.omicsonline.databinding.FragmentAbstractDisplayBinding;
import com.journals.omicsonline.databinding.FragmentJournalHomeBinding;
import com.journals.omicsonline.helper.utils;
import com.journals.omicsonline.ui.viewmodel.AbstactDisplayViewModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        abstactDisplayViewModel.getAbstractDisplayRepository().observe(getViewLifecycleOwner(), homeResponse -> {
           // List<JournalHomeResponse> catDetailsBeanList = homeResponse.getAbt_journal_details();
            Log.d(TAG, "onCreateView: "+homeResponse.isStatus());
