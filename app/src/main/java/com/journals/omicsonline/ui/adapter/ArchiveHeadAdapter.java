...
import com.journals.omicsonline.databinding.ArchiveHeadListItemBinding;
...
public class ArchiveHeadAdapter extends RecyclerView.Adapter<ArchiveHeadAdapter.ViewHolder> {
    ...
    public ArchiveHeadAdapter(List<ArchiveResponse.ArchiveYearsBean> modelList, String journalcode) {
    ...
    /*    for (ArchiveChildItem item : modelList.get(position).getChildItemList()){
        ...
        ArchiveChildAdapter archiveChildAdapter = new ArchiveChildAdapter(modelList.get(position).getArchiveDetails(),journalcode);
